...
config.$inject = ['BackandProvider', '$stateProvider', '$urlRouterProvider', '$httpProvider', 'configBackand'];

function config(BackandProvider, $stateProvider, $urlRouterProvider, $httpProvider, configBackand) {

  // Setup Backand Provider
  BackandProvider.setAnonymousToken(configBackand.anonymousToken);
  BackandProvider.setSignUpToken(configBackand.signUpToken);
  BackandProvider.setAppName(configBackand.appName);
